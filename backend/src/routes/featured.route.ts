...
router.put("/updateHeroAnime/:id", verifyToken, isAdmin, updateHeroAnime);
...
router.put("/updateAnimeNews/:id", verifyToken, isAdmin, updateAnimeNews);
...
router.put("/updateSuggestedAnime/:id", verifyToken, isAdmin, updateSuggestedAnime);
